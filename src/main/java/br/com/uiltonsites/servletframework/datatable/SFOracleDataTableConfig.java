 ...
 */
public class SFOracleDataTableConfig extends SFDataTableConfig {
    
    public SFOracleDataTableConfig(SFLogger logger) {
        super(logger);
    }

    @Override
    protected SFDataTableResponse initResponse(SFDataTableRequest dataTableRequest) {
        return new SFOracleDataTableResponse(dataTableRequest, queryTable);
    }
